...
public class StringMethods {
	public static void main(String[] args) {
		...
		String name = "Keshav";
		String name3 = "Keshavavav";
	    String name2 = "      Keshav     ";
//1.		System.out.println(name);	
//		    System.out.println(name.length());
//			System.out.println(name.toLowerCase());
//			System.out.println(name.toUpperCase());
//2.        System.out.println(name2);
//		    System.out.println(name.trim());
//		    System.out.println(name.substring(2));
//		    System.out.println(name.substring(2, 4));         // 4th will not be included
//3.	    System.out.println(name.replace('v', 'w'));
//		    System.out.println(name.replace("av", "we"));
...
//		    System.out.println(name.equalsIgnoreCase("keshav"));
